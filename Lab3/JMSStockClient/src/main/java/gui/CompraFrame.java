...
import com.mycompany.jmsstockclient.session.Utente;
...
public class CompraFrame extends JFrame implements Observer{
    ...
    private void impostaCaratteristicheGraficheEtichette() {
        ...
        this.utenteLbl.setPreferredSize(new Dimension(LABEL_WIDTH, labelHeight));
        this.nomeLbl.setPreferredSize(new Dimension(LABEL_WIDTH, labelHeight));
        this.prezzoLbl.setPreferredSize(new Dimension(LABEL_WIDTH, labelHeight));
        this.quantitaLbl.setPreferredSize(new Dimension(LABEL_WIDTH, labelHeight));
        this.importoComplessivoLbl.setPreferredSize(new Dimension(LABEL_WIDTH, labelHeight));

        this.utenteLbl.setHorizontalAlignment(JLabel.RIGHT);
        this.nomeLbl.setHorizontalAlignment(JLabel.RIGHT);
        this.prezzoLbl.setHorizontalAlignment(JLabel.RIGHT);
        this.quantitaLbl.setHorizontalAlignment(JLabel.RIGHT);
        this.importoComplessivoLbl.setHorizontalAlignment(JLabel.RIGHT);
    }
