 ...
 * generated in the aaaws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetClients_QNAME = new QName("http://aaaws/", "getClients");
    private final static QName _GetClientsResponse_QNAME = new QName("http://aaaws/", "getClientsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: aaaws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://aaaws/", name = "getClients")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://aaaws/", name = "getClientsResponse")
