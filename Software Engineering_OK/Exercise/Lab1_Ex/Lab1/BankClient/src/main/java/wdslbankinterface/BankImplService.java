 ...
 * 
 */
@WebServiceClient(name = "BankImplService", targetNamespace = "http://bankws/", wsdlLocation = "http://localhost:8080/BankInterface?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKIMPLSERVICE_QNAME = new QName("http://bankws/", "BankImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/BankInterface?wsdl");
    ...
    public BankIFace getBankImplPort() {
        return super.getPort(new QName("http://bankws/", "BankImplPort"), BankIFace.class);
    }
    ...
    public BankIFace getBankImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://bankws/", "BankImplPort"), BankIFace.class, features);
    }
