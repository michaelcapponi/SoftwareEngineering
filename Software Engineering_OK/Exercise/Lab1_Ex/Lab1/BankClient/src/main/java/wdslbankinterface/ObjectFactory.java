 ...
 * generated in the wdslbankinterface package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOperationDetailsByID_QNAME = new QName("http://bankws/", "getOperationDetailsByID");
    private final static QName _GetOperationDetailsByIDResponse_QNAME = new QName("http://bankws/", "getOperationDetailsByIDResponse");
    private final static QName _GetOperationsByClientID_QNAME = new QName("http://bankws/", "getOperationsByClientID");
    private final static QName _GetOperationsByClientIDResponse_QNAME = new QName("http://bankws/", "getOperationsByClientIDResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: wdslbankinterface
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankws/", name = "getOperationDetailsByID")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankws/", name = "getOperationDetailsByIDResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankws/", name = "getOperationsByClientID")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankws/", name = "getOperationsByClientIDResponse")
