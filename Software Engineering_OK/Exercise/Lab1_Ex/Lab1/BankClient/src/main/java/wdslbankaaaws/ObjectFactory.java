 ...
 * generated in the wdslbankaaaws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetClients_QNAME = new QName("http://bankaaaws/", "getClients");
    private final static QName _GetClientsResponse_QNAME = new QName("http://bankaaaws/", "getClientsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: wdslbankaaaws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankaaaws/", name = "getClients")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://bankaaaws/", name = "getClientsResponse")
